...
- `catalog/AnalysisPromo.tsx` and `catalog/AnalysisPromo.css`: animated homepage banner, alternating statistics and AntiNERO links with pause/manual controls and reduced-motion support.
