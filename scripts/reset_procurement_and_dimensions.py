...
Use this only when you want a full rebuild from source CSVs.
"""
...
def load_database_url() -> str:
    ...
    if not ENV_PATH.exists():
        raise RuntimeError("Missing DATABASE_URL and .env file was not found.")
...
def main() -> int:
    ...
    try:
        ...
        conn.commit()
        print("Reset completed: procurement + dimensions tables truncated.")
        return 0
