...
SECONDARY_CPVS: dict[str, str] = {
    ...
    "60424100-7":"Ενοικίαση αεροσκαφών με πλήρωμα",
    "50211310-3":"Υπηρεσίες γενικής επισκευής κινητήρων αεροσκαφών",
    "50211100-8":"Υπηρεσίες συντήρησης αεροσκαφών",
    "45000000-7":"Κατασκευαστικές εργασίες",
    "34731000-0":"Μέρη αεροσκαφών",
    "34731500-5":"Μέρη κινητήρων αεροσκαφών",
    "35642000-7":"Ηλεκτρονικά και ηλεκτρικά ανταλλακτικά μέρη για στρατιωτικό αεροδιαστημικό εξοπλισμό",
...
SECONDARY_TITLE_KEYWORDS = ["πυροπροστασ", "Πολιτικής προστασίας", "αντιπυρικ", "δασικών πυρκαγιών", "δασικών δρόμων", "κατασβεσ", "αεροπυροσβ", "ΠΥΡΟΣΒ"]
