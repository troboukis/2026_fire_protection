...
SELECT
  ...
  CASE
    WHEN COALESCE(o.organization_normalized_value, '') ILIKE 'ΔΗΜΟΣ%' THEN 'municipality'
    WHEN COALESCE(o.organization_normalized_value, '') ILIKE 'ΠΕΡΙΦΕΡΕΙΑ%' THEN 'region'
    WHEN COALESCE(o.organization_normalized_value, '') ILIKE '%ΑΠΟΚΕΝΤΡΩΜΕΝΗ%' THEN 'decentralized'
    ELSE 'other'
