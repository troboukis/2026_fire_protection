...
--   and p.proname in ('get_hero_section_data', 'get_homepage_funding', 'get_contracts_page', 'get_featured_beneficiaries', 'get_municipality_featured_beneficiaries', 'get_latest_contract_cards', 'get_municipality_map_spend_per_100k', 'get_latest_funding_year_municipality_spend', 'get_contract_analysis', 'get_direct_award_distribution', 'normalize_procedure_type');
